...
urlpatterns = [
    ...
    path('answer/modify/<int:question_id>/', answer_views.answer_modify, name='answer_modify'),
    ...
    path('comment/create/modify/<int:comment_id>/', comment_views.comment_modify_question, name='comment_modify_question'),
    path('comment/create/delete/<int:comment_id>/', comment_views.comment_delete_question, name='comment_delete_question'),
